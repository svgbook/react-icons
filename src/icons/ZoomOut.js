...
renderPath["fill"] = () => (
  <Fragment>
    <path
      stroke="none"
      d="M18.35,17.65,14.65,14a5.1,5.1,0,0,0,1.18-3.28,5.17,5.17,0,1,0-5.16,5.16A5.1,5.1,0,0,0,14,14.65l3.7,3.7a.48.48,0,0,0,.7,0A.48.48,0,0,0,18.35,17.65Zm-5.68-6.48h-4a.5.5,0,0,1-.5-.5.5.5,0,0,1,.5-.5h4a.5.5,0,0,1,.5.5A.51.51,0,0,1,12.67,11.17Z"
    />
  </Fragment>
);
