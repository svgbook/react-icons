...
renderPath["outline"] = (color) => (
  <Fragment>
    ...
    <path fill="none" d="M10.8,16.2,12,17.4l1.2-1.2" />
  </Fragment>
);
...
renderPath["duotone"] = (color) => (
  <Fragment>
    ...
    <path fill="none" strokeOpacity=".2" d="M10.8,16.2,12,17.4l1.2-1.2" />
  </Fragment>
);
...
renderPath["color"] = (color, secondaryColor) => (
  <Fragment>
    ...
    <path fill="none" stroke={secondaryColor} d="M10.8,16.2,12,17.4l1.2-1.2" />
  </Fragment>
);

const KeyboardShow = forwardRef((props, ref) => {
