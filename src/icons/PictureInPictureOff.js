...
renderPath["outline"] = (color) => (
  <Fragment>
    ...
    <path fill="none" d="M8.67,12V10h2" />
  </Fragment>
);
...
renderPath["duotone"] = (color) => (
  <Fragment>
    ...
    <path strokeOpacity=".2" fill="none" d="M8.67,12V10h2" />
  </Fragment>
);
...
renderPath["color"] = (color, secondaryColor) => (
  <Fragment>
    ...
    <path stroke={secondaryColor} fill="none" d="M8.67,12V10h2" />
  </Fragment>
);

const PictureInPictureOff = forwardRef((props, ref) => {
