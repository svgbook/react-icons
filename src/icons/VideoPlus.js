...
renderPath["outline"] = (color) => (
  <Fragment>
    ...
    <line x1="10" y1="10.67" x2="10" y2="13.33" />
  </Fragment>
);
...
renderPath["fill"] = () => (
  <Fragment>
    <path
      stroke="none"
      d="M18.38,9.22a1.19,1.19,0,0,0-.68-.58,1.15,1.15,0,0,0-.89.06L14.5,9.86V9.33A1.83,1.83,0,0,0,12.67,7.5H7.33A1.83,1.83,0,0,0,5.5,9.33v5.34A1.83,1.83,0,0,0,7.33,16.5h5.34a1.83,1.83,0,0,0,1.83-1.83v-.53l2.31,1.16a1.17,1.17,0,0,0,1.69-1.05V9.75A1.18,1.18,0,0,0,18.38,9.22Zm-7,3.28H10.5v.83a.5.5,0,0,1-1,0V12.5H8.67a.5.5,0,0,1,0-1H9.5v-.83a.5.5,0,0,1,1,0v.83h.83a.5.5,0,0,1,0,1Z"
    />
  </Fragment>
);
...
const VideoPlus = forwardRef((props, ref) => {
